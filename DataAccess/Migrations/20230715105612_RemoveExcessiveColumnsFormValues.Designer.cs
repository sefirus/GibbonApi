...
namespace DataAccess.Migrations
{
    ...
    [Migration("20230715105612_RemoveExcessiveColumnsFormValues")]
    partial class RemoveExcessiveColumnsFormValues
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Entities.DataType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 7, 15, 10, 56, 12, 583, DateTimeKind.Utc).AddTicks(9642),
                            ModifiedDate = new DateTime(2023, 7, 15, 10, 56, 12, 583, DateTimeKind.Utc).AddTicks(9647),
                            Name = "String"
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000002"),
                            CreatedDate = new DateTime(2023, 7, 15, 10, 56, 12, 583, DateTimeKind.Utc).AddTicks(9648),
                            ModifiedDate = new DateTime(2023, 7, 15, 10, 56, 12, 583, DateTimeKind.Utc).AddTicks(9649),
                            Name = "Int"
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000003"),
                            CreatedDate = new DateTime(2023, 7, 15, 10, 56, 12, 583, DateTimeKind.Utc).AddTicks(9651),
                            ModifiedDate = new DateTime(2023, 7, 15, 10, 56, 12, 583, DateTimeKind.Utc).AddTicks(9651),
                            Name = "Float"
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000004"),
                            CreatedDate = new DateTime(2023, 7, 15, 10, 56, 12, 583, DateTimeKind.Utc).AddTicks(9652),
                            ModifiedDate = new DateTime(2023, 7, 15, 10, 56, 12, 583, DateTimeKind.Utc).AddTicks(9652),
                            Name = "ObjectId"
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000005"),
                            CreatedDate = new DateTime(2023, 7, 15, 10, 56, 12, 583, DateTimeKind.Utc).AddTicks(9653),
                            ModifiedDate = new DateTime(2023, 7, 15, 10, 56, 12, 583, DateTimeKind.Utc).AddTicks(9662),
                            Name = "Uuid"
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000006"),
                            CreatedDate = new DateTime(2023, 7, 15, 10, 56, 12, 583, DateTimeKind.Utc).AddTicks(9669),
                            ModifiedDate = new DateTime(2023, 7, 15, 10, 56, 12, 583, DateTimeKind.Utc).AddTicks(9669),
                            Name = "Object"
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000007"),
                            CreatedDate = new DateTime(2023, 7, 15, 10, 56, 12, 583, DateTimeKind.Utc).AddTicks(9670),
                            ModifiedDate = new DateTime(2023, 7, 15, 10, 56, 12, 583, DateTimeKind.Utc).AddTicks(9671),
                            Name = "Array"
                        });
                });
            ...
            modelBuilder.Entity("Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "21c3b90a-a403-4bcc-bd40-4a5fda03a986",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEC91IMaSKOyCZDCW54LWduYYDT3AkOkimPxwHs1TPhomWFoGlZwgsVa2OdN73/qnBQ==",
                            PhoneNumber = "00 000 000 0000",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "64c205e8-ceff-4616-98cc-28f72dcff367",
