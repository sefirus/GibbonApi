...
namespace DataAccess.Migrations
{
    ...
    [Migration("20230721193847_AddRelationStoredDocumentPKToSchemaField")]
    partial class AddRelationStoredDocumentPKToSchemaField
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Entities.DataType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 7, 21, 19, 38, 47, 216, DateTimeKind.Utc).AddTicks(8599),
                            ModifiedDate = new DateTime(2023, 7, 21, 19, 38, 47, 216, DateTimeKind.Utc).AddTicks(8604),
                            Name = "String"
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000002"),
                            CreatedDate = new DateTime(2023, 7, 21, 19, 38, 47, 216, DateTimeKind.Utc).AddTicks(8606),
                            ModifiedDate = new DateTime(2023, 7, 21, 19, 38, 47, 216, DateTimeKind.Utc).AddTicks(8606),
                            Name = "Int"
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000003"),
                            CreatedDate = new DateTime(2023, 7, 21, 19, 38, 47, 216, DateTimeKind.Utc).AddTicks(8607),
                            ModifiedDate = new DateTime(2023, 7, 21, 19, 38, 47, 216, DateTimeKind.Utc).AddTicks(8608),
                            Name = "Float"
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000004"),
                            CreatedDate = new DateTime(2023, 7, 21, 19, 38, 47, 216, DateTimeKind.Utc).AddTicks(8609),
                            ModifiedDate = new DateTime(2023, 7, 21, 19, 38, 47, 216, DateTimeKind.Utc).AddTicks(8609),
                            Name = "ObjectId"
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000005"),
                            CreatedDate = new DateTime(2023, 7, 21, 19, 38, 47, 216, DateTimeKind.Utc).AddTicks(8610),
                            ModifiedDate = new DateTime(2023, 7, 21, 19, 38, 47, 216, DateTimeKind.Utc).AddTicks(8619),
                            Name = "Uuid"
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000006"),
                            CreatedDate = new DateTime(2023, 7, 21, 19, 38, 47, 216, DateTimeKind.Utc).AddTicks(8624),
                            ModifiedDate = new DateTime(2023, 7, 21, 19, 38, 47, 216, DateTimeKind.Utc).AddTicks(8625),
                            Name = "Object"
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000007"),
                            CreatedDate = new DateTime(2023, 7, 21, 19, 38, 47, 216, DateTimeKind.Utc).AddTicks(8626),
                            ModifiedDate = new DateTime(2023, 7, 21, 19, 38, 47, 216, DateTimeKind.Utc).AddTicks(8626),
                            Name = "Array"
                        });
                });
            ...
            modelBuilder.Entity("Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "d8b74840-41ea-4ee6-a425-d1637893f2e4",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEHM87ertoks99nVjP0ztHEHOPNzhaUAq7zX5hPs8e4zu05IWoeI8YGYzH1c/pMjRLA==",
                            PhoneNumber = "00 000 000 0000",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "b9f8efbf-07f7-4148-846c-f66decd3f972",
