...
namespace DataAccess.Migrations
{
    ...
    [Migration("20230711204546_RemoveNestedTypes")]
    partial class RemoveNestedTypes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Entities.DataType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 7, 11, 20, 45, 45, 952, DateTimeKind.Utc).AddTicks(1072),
                            ModifiedDate = new DateTime(2023, 7, 11, 20, 45, 45, 952, DateTimeKind.Utc).AddTicks(1075),
                            Name = "String"
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000002"),
                            CreatedDate = new DateTime(2023, 7, 11, 20, 45, 45, 952, DateTimeKind.Utc).AddTicks(1077),
                            ModifiedDate = new DateTime(2023, 7, 11, 20, 45, 45, 952, DateTimeKind.Utc).AddTicks(1077),
                            Name = "Int"
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000003"),
                            CreatedDate = new DateTime(2023, 7, 11, 20, 45, 45, 952, DateTimeKind.Utc).AddTicks(1079),
                            ModifiedDate = new DateTime(2023, 7, 11, 20, 45, 45, 952, DateTimeKind.Utc).AddTicks(1079),
                            Name = "Float"
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000004"),
                            CreatedDate = new DateTime(2023, 7, 11, 20, 45, 45, 952, DateTimeKind.Utc).AddTicks(1080),
                            ModifiedDate = new DateTime(2023, 7, 11, 20, 45, 45, 952, DateTimeKind.Utc).AddTicks(1080),
                            Name = "ObjectId"
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000005"),
                            CreatedDate = new DateTime(2023, 7, 11, 20, 45, 45, 952, DateTimeKind.Utc).AddTicks(1081),
                            ModifiedDate = new DateTime(2023, 7, 11, 20, 45, 45, 952, DateTimeKind.Utc).AddTicks(1082),
                            Name = "Uuid"
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000006"),
                            CreatedDate = new DateTime(2023, 7, 11, 20, 45, 45, 952, DateTimeKind.Utc).AddTicks(1087),
                            ModifiedDate = new DateTime(2023, 7, 11, 20, 45, 45, 952, DateTimeKind.Utc).AddTicks(1088),
                            Name = "Object"
                        },
                        new
                        {
                            Id = new Guid("00000000-0000-0000-0000-000000000007"),
                            CreatedDate = new DateTime(2023, 7, 11, 20, 45, 45, 952, DateTimeKind.Utc).AddTicks(1089),
                            ModifiedDate = new DateTime(2023, 7, 11, 20, 45, 45, 952, DateTimeKind.Utc).AddTicks(1089),
                            Name = "Array"
                        });
                });
            ...
            modelBuilder.Entity("Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "cb8da24e-3d50-4d0a-b0e4-ddd82b005be3",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAELI7W1vK2jifEMmHoM22zN5A6qwY38Q2iQtgI+ZR+RRrJ33M51XXUO9NsTh9OkgIyw==",
                            PhoneNumber = "00 000 000 0000",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "8f5d1bbe-b655-4dc7-b8ed-e713904d0f7a",
